...
class WikisControllerTest < ActionController::TestCase
  ...
  test "should create wiki" do
    assert_difference('Wiki.count') do
      post :create, wiki: { description: @wiki.description, name: @wiki.name, public: @wiki.public }
    end
  ...
  test "should update wiki" do
    patch :update, id: @wiki, wiki: { description: @wiki.description, name: @wiki.name, public: @wiki.public }
    assert_redirected_to wiki_path(assigns(:wiki))
  end
